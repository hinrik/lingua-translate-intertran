# This Makefile is for the Lingua::Translate::InterTran extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Lingua/Translate/InterTran.pm]
#     AUTHOR => q[Hinrik Örn Sigurðsson <hinrik.sig@gmail.com>]
#     LICENSE => q[perl]
#     NAME => q[Lingua::Translate::InterTran]
#     PREREQ_PM => { Test::More=>q[0], URI=>q[0], LWP::UserAgent=>q[0], Lingua::Translate=>q[0.08] }
#     VERSION_FROM => q[lib/Lingua/Translate/InterTran.pm]
...
NAME_SYM = Lingua_Translate_InterTran
VERSION = 0.01
...
FULLEXT = Lingua/Translate/InterTran
BASEEXT = InterTran
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Lingua/Translate/InterTran.pm
...
TO_INST_PM = lib/Lingua/Translate/InterTran.pm

PM_TO_BLIB = lib/Lingua/Translate/InterTran.pm \
...
DISTVNAME = Lingua-Translate-InterTran-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Lingua/Translate/InterTran.pm $(INST_MAN3DIR)/Lingua::Translate::InterTran.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Lingua-Translate-InterTran' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Lingua/Translate/InterTran.pm' >> META_new.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '    Lingua::Translate:             0.08' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>A L&lt;Lingua::Translate|Lingua::Translate&gt; backend</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Hinrik Örn Sigurðsson &lt;hinrik.sig@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="LWP-UserAgent" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Lingua-Translate" VERSION="0,08,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Lingua/Translate/InterTran.pm blib/lib/Lingua/Translate/InterTran.pm 
